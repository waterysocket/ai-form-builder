import { Bell, Paintbrush, X } from 'lucide-react'
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-lg bg-surface-base border border-border-subtle rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="px-6 py-4 border-b border-border-subtle flex items-center justify-between bg-surface-raised">
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-full hover:bg-surface-elevated text-text-muted hover:text-text-primary transition"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
              ...
              <div className="space-y-4 pt-4 border-t border-border-subtle">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    disabled
                    className="w-full px-4 py-2.5 rounded-xl bg-surface-raised border border-border-subtle opacity-50 cursor-not-allowed text-sm text-text-primary"
                  />
                </div>
              </div>
            </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-text-muted">
                      Get emails when you receive responses
                    </div>
                  </div>
                </div>
        ...
        <div className="px-6 py-4 border-t border-border-subtle bg-surface-raised flex justify-end gap-3">
          ...
          <button
            onClick={handleSave}
            className="px-4 py-2 rounded-xl text-sm font-medium text-white bg-gradient-to-r from-brand to-brand-dark hover:opacity-90 transition shadow-lg shadow-brand/20"
          >
            Save Changes
          </button>
        </div>
