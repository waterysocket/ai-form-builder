    ...
    <header className="sticky top-0 z-50 glass border-b border-border-subtle/60">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm text-text-secondary">
          ...
          <a href="#how" className="hover:text-brand transition">
            How it works
          </a>
      ...
      {open && (
        <div className="md:hidden border-t border-border-subtle px-6 py-5 flex flex-col gap-4 bg-surface-raised">
          <a href="#features" className="text-text-secondary hover:text-brand">
            Features
          </a>
          <a href="#how" className="text-text-secondary hover:text-brand">
            How it works
          </a>
          <a href="#pricing" className="text-text-secondary hover:text-brand">
            Pricing
          </a>
          <Link to="/auth" className="text-text-secondary">
            Sign In
          </Link>
    ...
    <section className="relative px-6 pt-24 pb-36 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center relative">
        ...
        <p className="mt-6 text-lg md:text-xl text-text-secondary max-w-2xl mx-auto leading-relaxed">
          Build beautiful surveys in minutes. Let AI write the questions, style the page, and make
...
function Stat({ n, l }: { n: string; l: string }) {
  return (
    <div>
      <span className="text-brand font-bold">{n}</span> <span className="text-text-muted">{l}</span>
    </div>
  )
}
function Divider() {
      ...
      <div className="relative rounded-2xl border border-border-strong bg-surface-raised shadow-brand-glow-lg overflow-hidden text-left">
        ...
        <div className="grid grid-cols-12 min-h-[380px]">
          <div className="col-span-3 border-r border-border-subtle p-4 space-y-2">
            ...
            {["What's your name?", 'How did you hear about us?', 'Rate your experience'].map(
              (q, i) => (
                <div
                  key={q}
          ...
          <div className="col-span-9 p-10 flex flex-col justify-center bg-gradient-to-br from-surface-base to-surface-raised">
            ...
            <div className="mt-6 flex gap-3">
              ...
              <button className="px-5 py-2 text-sm rounded-xl btn-brand">Next →</button>
            </div>
          </div>
        </div>
      </div>
...
const features = [
  {
    icon: Palette,
    title: 'AI Styling',
    desc: 'Describe a vibe. Get a fully styled survey. Instantly.',
  },
  {
    icon: Bot,
    title: 'Question AI',
    desc: 'Generate, refine, and improve questions from a chat panel.',
  },
  {
    icon: FileText,
    title: 'Two Layout Modes',
    desc: 'Paginated like Typeform or scrollable like a classic form — your call.',
  },
  {
    icon: Sparkles,
    title: 'Brand Control',
    desc: 'Your logo, your colors, your font. Every survey, on-brand.',
  },
  {
    icon: Link2,
    title: 'Instant Sharing',
    desc: 'One link. Anyone can respond. No login required.',
  },
  {
    icon: BarChart3,
    title: 'Response Dashboard',
    desc: 'See every response the moment it arrives.',
  },
]
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-text-primary">
            Everything you need. <span className="text-text-muted">Nothing you don't.</span>
          </h2>
        </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-stretch">
        <div className="flex-1 px-6 py-16 md:p-20 flex flex-col justify-center">
          ...
          <p className="mt-6 text-text-secondary text-lg leading-relaxed max-w-lg">
            With AI-powered styling, every survey you create is stunning — right out of the box. No
...
function HowItWorks() {
  const steps = [
    { n: '01', t: 'Build', d: 'Add questions, choose types, arrange them however you want.' },
    {
      n: '02',
      t: 'Style',
      d: 'Pick a preset or describe your aesthetic to our AI — it handles the rest.',
    },
      ...
      <div className="max-w-6xl mx-auto rounded-3xl border border-brand/30 bg-surface-raised p-8 md:p-12 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="mt-4 text-text-secondary leading-relaxed">
            Tell the styling agent what you want — "make it feel like a moonlit jazz bar" or "clean
            corporate blue" — and it generates a complete visual theme for your survey page.
...
function CtaBanner() {
  return (
    <section
      id="pricing"
      className="px-6 py-28 relative overflow-hidden border-t border-border-subtle"
    >
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        <h2 className="text-4xl md:text-5xl font-bold tracking-tight">
          Ready to build something <span className="text-gradient-brand">beautiful?</span>
        </h2>
